...
class DictionariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dictionary" do
    assert_difference('Dictionary.count') do
      post dictionaries_url, params: { dictionary: { description: @dictionary.description, edition: @dictionary.edition, name: @dictionary.name, position: @dictionary.position } }
    end

    assert_redirected_to dictionary_path(Dictionary.last)
  end
  ...
  test "should update dictionary" do
    patch dictionary_url(@dictionary), params: { dictionary: { description: @dictionary.description, edition: @dictionary.edition, name: @dictionary.name, position: @dictionary.position } }
